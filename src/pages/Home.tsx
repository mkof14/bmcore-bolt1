...
export default function Home({ onNavigate }: HomeProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-8 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50">
              <div className="text-5xl font-bold text-orange-500 dark:text-orange-400 mb-3">
                12,000+
              </div>
            ...
            <div className="text-center p-8 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50">
              <div className="text-5xl font-bold text-blue-500 dark:text-blue-400 mb-3">
                98.5%
              </div>
              <div className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                Success Rate
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">
                Users report improved health awareness
              </div>
            </div>

            <div className="text-center p-8 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50">
              <div className="text-5xl font-bold text-green-500 dark:text-green-400 mb-3">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              onClick={() => onNavigate('signup')}
              className="group px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 dark:from-orange-600 dark:to-orange-700 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center gap-3"
            >
              Get Started Free
            ...
            <button
              ...
              className="px-8 py-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-xl font-semibold text-lg border-2 border-gray-300 dark:border-gray-600 hover:border-orange-500 dark:hover:border-orange-500 transition-all duration-300"
            >
              Learn More
            </button>
          </div>
