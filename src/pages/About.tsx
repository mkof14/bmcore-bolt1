        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-blue-400 tracking-wide uppercase">Technology</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              The BioMath Core <span className="text-blue-400">AI Engine</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-6 hover:border-blue-500/50 transition-colors">
              <h3 className="text-lg font-bold text-white mb-3">Model-first design</h3>
            ...
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-6 hover:border-blue-500/50 transition-colors">
              <h3 className="text-lg font-bold text-white mb-3">Multi-modal fusion</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-6 hover:border-blue-500/50 transition-colors">
              <h3 className="text-lg font-bold text-white mb-3">Outcome orientation</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-orange-500/10 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-orange-500 tracking-wide uppercase">Philosophy</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8">
              <h3 className="text-xl font-bold text-white mb-4">Data belongs to you</h3>
            ...
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8">
              <h3 className="text-xl font-bold text-white mb-4">Knowledge is power</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8">
              <h3 className="text-xl font-bold text-white mb-4">AI is an assistant</h3>
              <p className="text-gray-400 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/10 border border-purple-500/30 rounded-xl p-6 text-center">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Family Focused</h3>
              <p className="text-gray-400 text-sm">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 to-gray-950">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8 hover:border-orange-500/50 transition-colors">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-2 h-2 rounded-full bg-orange-500 mt-2"></div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Individual Users</h3>
                  <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8 hover:border-orange-500/50 transition-colors">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-2 h-2 rounded-full bg-orange-500 mt-2"></div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Families</h3>
                  <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8 hover:border-orange-500/50 transition-colors">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-2 h-2 rounded-full bg-orange-500 mt-2"></div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Clinics & Corporate Clients</h3>
                  <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl p-8 hover:border-orange-500/50 transition-colors">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-2 h-2 rounded-full bg-orange-500 mt-2"></div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Investors & Partners</h3>
                  <p className="text-gray-400 leading-relaxed">
