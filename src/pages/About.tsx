    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <div className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <div className="group relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700/50 rounded-2xl p-8 hover:border-orange-600/50 transition-all duration-500 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-4 group-hover:text-orange-50 transition-colors">Our Mission</h2>
              ...
              <div className="group relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700/50 rounded-2xl p-8 hover:border-orange-600/50 transition-all duration-500 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-4 group-hover:text-orange-50 transition-colors">Our Founder</h2>
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">The BioMath Core AI Engine</h2>
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="group relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700/50 rounded-2xl p-8 hover:border-orange-600/50 transition-all duration-500 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-900/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative">
                  <h3 className="text-xl font-bold text-white mb-4 group-hover:text-orange-50 transition-colors">Data belongs to you</h3>
                  <p className="text-gray-400 leading-relaxed">
              ...
              <div className="group relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700/50 rounded-2xl p-8 hover:border-orange-600/50 transition-all duration-500 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-900/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative">
                  <h3 className="text-xl font-bold text-white mb-4 group-hover:text-orange-50 transition-colors">Knowledge is power</h3>
                  <p className="text-gray-400 leading-relaxed">
              ...
              <div className="group relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700/50 rounded-2xl p-8 hover:border-orange-600/50 transition-all duration-500 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-900/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative">
                  <h3 className="text-xl font-bold text-white mb-4 group-hover:text-orange-50 transition-colors">AI is an assistant</h3>
                  <p className="text-gray-400 leading-relaxed">
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">Platform Highlights</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="group relative bg-gradient-to-b from-gray-800/50 to-gray-900/50 border border-gray-700/40 rounded-xl p-6 text-center hover:border-orange-600/40 transition-all duration-300 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-white font-bold mb-2 text-lg">AI-Powered Insights</h3>
              ...
              <div className="group relative bg-gradient-to-b from-gray-800/50 to-gray-900/50 border border-gray-700/40 rounded-xl p-6 text-center hover:border-orange-600/40 transition-all duration-300 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-white font-bold mb-2 text-lg">HIPAA Compliant</h3>
                  <p className="text-sm text-gray-400">
              ...
              <div className="group relative bg-gradient-to-b from-gray-800/50 to-gray-900/50 border border-gray-700/40 rounded-xl p-6 text-center hover:border-orange-600/40 transition-all duration-300 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-white font-bold mb-2 text-lg">Family Focused</h3>
                  <p className="text-sm text-gray-400">
              ...
              <div className="group relative bg-gradient-to-b from-gray-800/50 to-gray-900/50 border border-gray-700/40 rounded-xl p-6 text-center hover:border-orange-600/40 transition-all duration-300 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-white font-bold mb-2 text-lg">Real-Time Analytics</h3>
                  <p className="text-sm text-gray-400">
