...
export default function Ambassador({ onNavigate }: AmbassadorProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white dark:from-gray-900 dark:to-gray-800 pt-20 pb-16 transition-colors">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl p-8 mb-12 text-white">
          <h2 className="text-2xl font-bold mb-6 text-center">What Makes an Ambassador?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Higher Rewards</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Priority Access</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Co-Branded Tools</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm border border-gray-200 dark:border-gray-700 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Ambassador Benefits</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <CheckCircle className="h-5 w-5 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">Enhanced Rewards</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Double the standard referral rate with scaling tiers</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="h-5 w-5 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">Dedicated Dashboard</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Track cohort, lifetime rewards, and ambassador tier level</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="h-5 w-5 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">Co-Branded Materials</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Professional social assets and sharing toolkit</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Direct access to platform team for questions</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="h-5 w-5 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">Early Features</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Beta testing and preview access to new platform capabilities</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="h-5 w-5 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">Revenue-Sharing Growth</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Eligibility for advanced partnership models</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm border border-gray-200 dark:border-gray-700 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Ambassador Responsibilities</h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm border border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Apply to Become an Ambassador</h2>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold rounded-lg transition-all transform hover:scale-[1.02]"
              >
                Submit Application
              </button>
            </form>
        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-900 dark:text-white">Already have 10+ referrals?</span> Check your{' '}
            <button
