  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <div className="flex pt-16">
        <aside className="hidden lg:block fixed left-0 top-16 h-[calc(100vh-4rem)] w-72 bg-white/80 dark:bg-gray-900/50 border-r border-gray-200 dark:border-gray-800 overflow-y-auto z-10 backdrop-blur">
          <div className="p-6">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${
                      activeSection === section.id
                        ? 'bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-600/40 text-orange-700 dark:text-orange-300'
        ...
        <main className="flex-1 lg:ml-72">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <section id="overview" className="mb-20">
              <div className="text-center mb-12 rounded-3xl border border-gray-100 dark:border-gray-800 bg-[radial-gradient(circle_at_top,_#fff6ed,_transparent_55%),linear-gradient(135deg,#f8fafc,white)] dark:bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.18),_transparent_55%),linear-gradient(135deg,#0f172a,#020617)] p-12">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                  Transform your health data into personalized insights with our multi‑model AI system.
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-12">
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 text-center shadow-sm">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Dual AI Models</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Two independent AI systems analyze your data for comprehensive insights</p>
                </div>

                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 text-center shadow-sm">
                  <div className="w-16 h-16 bg-purple-50 border border-purple-200 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Shield className="h-8 w-8 text-purple-600" />
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Bank-Level Security</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">HIPAA-compliant encryption protects your sensitive health data</p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 text-center shadow-sm">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Instant analysis as new data comes in from your devices</p>
                </div>
              </div>
            </section>
            ...
            <div className="space-y-16">
              <section id="signup" className="scroll-mt-20">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h2 className="text-3xl font-semibold text-gray-900 dark:text-white">Sign Up & Create Your Profile</h2>
                </div>

                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                      <div className="aspect-video bg-gradient-to-br from-orange-50 to-pink-50 dark:from-orange-900/20 dark:to-pink-900/20 rounded-lg flex items-center justify-center mb-4">
                        <Users className="h-24 w-24 text-orange-500 opacity-50" />
                      </div>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Getting Started is Easy</h3>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-gray-900 dark:text-white font-medium">Secure Registration</p>
                          <p className="text-sm text-gray-600 dark:text-gray-400">Your data is encrypted from the moment you sign up</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-orange-600 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                          <p className="text-gray-900 dark:text-white font-medium">Health Profile</p>
                          <p className="text-sm text-gray-600 dark:text-gray-400">Tell us about your medical history and goals</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-orange-600 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                          <p className="text-gray-900 dark:text-white font-medium">Preference Settings</p>
                          <p className="text-sm text-gray-600 dark:text-gray-400">Customize notifications and report frequency</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <section id="connect" className="scroll-mt-20">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h2 className="text-3xl font-semibold text-gray-900 dark:text-white">Connect Your Health Devices</h2>
                </div>

                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="order-2 md:order-1">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Seamless Integration</h3>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-3 shadow-sm">
                        ...
                        <p className="text-sm font-medium text-gray-900 dark:text-white">Fitness Trackers</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Apple Watch, Fitbit, Garmin</p>
                      </div>
                      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-3 shadow-sm">
                        <Heart className="h-6 w-6 text-red-500 mb-2" />
                        <p className="text-sm font-medium text-gray-900 dark:text-white">Health Monitors</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">BP, glucose, weight scales</p>
                      </div>
                      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-3 shadow-sm">
                        <Brain className="h-6 w-6 text-purple-600 mb-2" />
                        <p className="text-sm font-medium text-gray-900 dark:text-white">Health Apps</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Apple Health, Google Fit</p>
                      </div>
                      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-3 shadow-sm">
                        <FileText className="h-6 w-6 text-green-600 mb-2" />
                        <p className="text-sm font-medium text-gray-900 dark:text-white">Lab Results</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Upload PDF reports</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="order-1 md:order-2">
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                      <div className="aspect-video bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg flex items-center justify-center mb-4">
              ...
              <section id="analyze" className="scroll-mt-20">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h2 className="text-3xl font-semibold text-gray-900 dark:text-white">AI Analyzes Your Data</h2>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 mb-8 shadow-sm">
                  ...
                  <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-600/30 rounded-lg">
                    <p className="text-sm text-blue-700 dark:text-blue-300 flex items-start gap-2">
                      <Zap className="h-5 w-5 flex-shrink-0 mt-0.5 text-blue-600 dark:text-blue-300" />
                      <span>
              ...
              <section id="reports" className="scroll-mt-20">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h2 className="text-3xl font-semibold text-gray-900 dark:text-white">Receive Comprehensive Reports</h2>
                </div>

                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    <FileText className="h-12 w-12 text-green-600 mb-4" />
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Daily Insights</h3>
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Weekly Analysis</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Monthly Deep Dive</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section id="action" className="scroll-mt-20">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h2 className="text-3xl font-semibold text-gray-900 dark:text-white">Take Action on Insights</h2>
                </div>

                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                      <Target className="h-10 w-10 text-yellow-500 mb-3" />
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Set Goals</h3>
                    ...
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Follow Recommendations</h3>
                      <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">
                  ...
                  <div className="space-y-6">
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Share with Healthcare Team</h3>
                      <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">
              ...
              <section id="black-box" className="scroll-mt-20">
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center justify-center gap-3">
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 mb-8 shadow-sm">
                  <div className="grid md:grid-cols-2 gap-8 mb-8">
                    <div>
                      ...
                      <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                        <li className="flex items-start gap-2">
                          ...
                          <span><strong className="text-gray-900 dark:text-white">Comprehensive Storage:</strong> All your health data in one encrypted vault</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                          <span><strong className="text-gray-900 dark:text-white">Automatic Sync:</strong> Real-time updates from all connected devices</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                          <span><strong className="text-gray-900 dark:text-white">Historical Records:</strong> Complete timeline of your health journey</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                          <span><strong className="text-gray-900 dark:text-white">Emergency Access:</strong> Share with healthcare providers instantly</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="bg-slate-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                          <Activity className="h-5 w-5 text-blue-600 mb-2" />
                          <p className="text-gray-900 dark:text-white font-medium text-sm">Vital Signs & Metrics</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">Heart rate, BP, oxygen levels, temperature</p>
                        </div>
                        <div className="bg-slate-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                          <FileText className="h-5 w-5 text-green-600 mb-2" />
                          <p className="text-gray-900 dark:text-white font-medium text-sm">Medical Records</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">Lab results, prescriptions, diagnoses</p>
                        </div>
                        <div className="bg-slate-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                          <Heart className="h-5 w-5 text-red-500 mb-2" />
                          <p className="text-gray-900 dark:text-white font-medium text-sm">Lifestyle Data</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">Exercise, sleep, nutrition, stress levels</p>
                        </div>
                        <div className="bg-slate-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                          <Brain className="h-5 w-5 text-purple-600 mb-2" />
                          <p className="text-gray-900 dark:text-white font-medium text-sm">AI Insights</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">Analysis results, predictions, recommendations</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-600/30 rounded-lg">
                    <p className="text-sm text-orange-700 dark:text-orange-300 flex items-start gap-2">
                      <Box className="h-5 w-5 flex-shrink-0 mt-0.5 text-orange-600 dark:text-orange-300" />
                      <span>
              ...
              <section id="dual-ai" className="scroll-mt-20">
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-sm">
                  <div className="grid md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="text-center">
                      <div className="w-16 h-16 bg-pink-50 border border-pink-200 rounded-full flex items-center justify-center mx-auto mb-4">
                        <Brain className="h-8 w-8 text-pink-600" />
                      </div>
                      <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Comprehensive View</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div className="p-4 bg-slate-50 dark:bg-gray-900/50 rounded-lg">
                    <p className="text-sm text-gray-600 dark:text-gray-300 text-center">
                      <strong className="text-gray-900 dark:text-white">Learn More:</strong> Visit our{' '}
                      <button
              ...
              <section id="categories" className="scroll-mt-20">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Cardiovascular Health</h3>
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Physical Activity</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    <Brain className="h-12 w-12 text-purple-600 mb-4" />
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Sleep & Recovery</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Metabolic Health</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Mental Wellness</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Clinical Markers</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                ...
                <div className="bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200 dark:border-cyan-600/30 rounded-2xl p-6">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 text-center">And Many More Categories</h3>
              ...
              <section id="learning" className="scroll-mt-20">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Health Education Hub</h3>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                <div className="bg-slate-50 dark:bg-green-900/20 border border-gray-200 dark:border-green-600/30 rounded-xl p-6">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Visit Our Learning Center</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Explore our full library of health education resources</p>
                    </div>
                    <button
              ...
              <section id="faq" className="scroll-mt-20">
                ...
                <div className="space-y-4 mb-8">
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-start gap-2">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-600/30 rounded-xl p-6">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Still Have Questions?</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Visit our complete FAQ page or contact our support team</p>
                    </div>
                    <button
              ...
              <section id="security" className="scroll-mt-20">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Your Control</h3>
                    <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-300">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
            ...
            <section className="mt-20 text-center">
              <div className="bg-gradient-to-br from-slate-950 via-gray-950 to-slate-900 border border-slate-800/80 rounded-2xl p-12">
                <h2 className="text-3xl font-semibold text-white mb-4">Ready to Transform Your Health?</h2>
