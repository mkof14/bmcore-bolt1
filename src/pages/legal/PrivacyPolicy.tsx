      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none dark:prose-invert">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 mb-8">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3 mt-0">Important Notice</h3>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">1.1 Personal Information</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">1.2 Health and Wellness Data</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">1.3 Technical Information</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">2.1 Service Provision</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">2.2 Platform Improvement</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">2.3 Communication</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">2.4 Legal and Security</h3>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">3.1 With Your Consent</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              We will share your information when you explicitly authorize us to do so, such as:
            </p>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Technical Safeguards</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Organizational Safeguards</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">5.1 Access and Portability</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">5.2 Correction and Update</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              <li>Correct inaccurate or incomplete information</li>
              <li>Update your profile and preferences at any time</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">5.3 Deletion</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">5.4 Restrict or Object</h3>
            <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">5.5 Withdraw Consent</h3>
            <p className="text-gray-700 dark:text-gray-300">
